 ...
 *
 * Original Driver:
 * https://github.com/dgasparri/SmartThingsPublic/blob/master/devicetypes/dgasparri/shelly-2-as-roller-shutter.src/shelly-2-as-roller-shutter.groovy
 */
 
 

metadata {
	definition (name: "Shelly 2 as Roller Shutter", namespace: "shelly", author: "Duccio Marco Gasparri", ocfDeviceType: "oic.d.blind", vid: "generic-shade") { //namespace: "dgasparri"
		capability "Actuator"
		capability "Sensor"
