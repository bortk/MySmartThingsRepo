 ...
 * 
 *  Original Driver:
 *  https://github.com/patrickkpowell/SmartThingsPublic/blob/master/devicetypes/patrickkpowell/Shelly/shelly-1or2.groovy
 */
metadata {
  definition (name: "Shelly1or2", namespace: "shelly", author: "Patrick Powell") { //namespace: "patrickkpowell",
    capability "switch"
    attribute "ip", "string"
  }
