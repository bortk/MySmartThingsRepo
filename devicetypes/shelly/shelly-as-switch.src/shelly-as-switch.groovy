 ...
 *
 *  Boris Comments
 *  Original: https://github.com/dgasparri/SmartThingsPublic/blob/master/devicetypes/dgasparri/shelly-as-switch.src/shelly-as-switch.groovy
...
metadata {
	definition (name: "Shelly as Switch", namespace: "shelly", author: "Duccio Marco Gasparri") { //namespace: "dgasparri"
		capability "Actuator"
		capability "Sensor"
