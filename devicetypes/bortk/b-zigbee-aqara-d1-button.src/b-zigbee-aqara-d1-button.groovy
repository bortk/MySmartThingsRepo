...
def configure() {
    ...
    cmds += zigbee.configureReporting(zigbee.POWER_CONFIGURATION_CLUSTER, DataType.UINT8, 30, 21600, 0x01)
    cmds += bindings
    cmds += zigbee.readAttribute(zigbee.POWER_CONFIGURATION_CLUSTER)
    return cmds
}
