...
metadata {
    definition (name:"Dev Radio Thermostat", namespace:"bortk", author:"Boris Tsirulnik") {
    ...
    simulator {
        status "Temperature 20.0":      "simulator:true, temp:20.00"
        status "Cooling Setpoint 22.0": "simulator:true, t_cool:22.00"
        status "Heating Setpoint 24.0": "simulator:true, t_cool:24.00"
...
def installed() {
    ...
    sendEvent([name:'heatingSetpoint', value:'25', displayed:false])
    sendEvent([name:'coolingSetpoint', value:'22', displayed:false])
...
private def printTitle() {
    log.info "Radio Thermostat. ${textVersion()}. }"
}

private def textVersion() {
    return "Version 0.0.1 (1/2/2022)"
}
