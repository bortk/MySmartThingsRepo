...
metadata {
    definition (name: 'B Xiaomi Aqara Wireless Switch', namespace: 'bortk-dev', author: 'bspranger', minHubCoreVersion: '000.022.0002', ocfDeviceType: 'x.com.st.d.remotecontroller') {
        capability 'Battery'
        capability 'Sensor'
        capability 'Button'
